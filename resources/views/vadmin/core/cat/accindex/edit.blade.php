                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="file" name="picture" value="Upload file" class="form-control">
                       @if(!empty($arItem->picture))
                          <a href="{{asset('/storage/app/media/files/article/'.$arItem->picture)}}" target="_blank"><img height="100px" src="{{asset('/storage/app/media/files/article/'.$arItem->picture)}}" alt=""></a>
                      @else
