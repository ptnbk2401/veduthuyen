...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Advertisement <small>Add</small></h3>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br>
            <form action="{{ route('vadmin.core.ads.add') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
              {{ csrf_field() }}
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Advertisement name</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" name="aname" value="{{ old('aname')}}" class="form-control" placeholder="Advertisement name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <textarea  class="form-control" rows="5" name="code_adsense" placeholder="Enter code adsense"></textarea>
                    </div>
                </div>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select name="position_id" class="form-control">
                            ...
                            @foreach($objItemsByPosition as $adsposition)
                                 <option value="{{$adsposition->position_id}}" >{{$adsposition->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="date" name="begin_at"  value="{{ old('begin_at')}}" class="form-control">
                    </div>
                </div>
