...
function countCheckedVne(){"all"===checkState&&$(".bulk_action input.vnedel").iCheck("check"),"none"===checkState&&$(".bulk_action input.vnedel").iCheck("uncheck");var c=$(".bulk_action input.vnedel:checked").length;c?($(".column-title").hide(),$(".bulk-actions").show(),$(".action-cnt").html(c+" dòng được chọn")):($(".column-title").show(),$(".bulk-actions").hide())}$(".bulk_action input#check-all-vne").on("ifChecked",function(){checkState="all",countCheckedVne()}),$(".bulk_action input#check-all-vne").on("ifUnchecked",function(){checkState="none",countCheckedVne()});